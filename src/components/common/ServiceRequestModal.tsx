          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
              <div>
                ...
                >
                  <option value="Sistema de Presión Constante">Sistema de Presión Constante (Bombas VFD)</option>
                  <option value="Bomba Sumergible / Pozo de Aguas Negras">Bomba Sumergible / Pozo de Aguas Negras & Eyectores</option>
                  <option value="Red Contra Incendio (RCI)">Red Contra Incendio (RCI / NFPA 20 / Bombas Jockey)</option>
                  <option value="Unidades Hidráulicas HPU & Cilindros">Unidades Hidráulicas HPU & Cilindros Industriales</option>
                  <option value="Prensas Hidráulicas Industriales">Prensas Hidráulicas Industriales</option>
                  <option value="Planta de Tratamiento & Osmosis PTAR">Planta de Tratamiento & Osmosis PTAR</option>
                  <option value="Tableros de Control & Variadores de Frecuencia">Tableros de Control & Variadores de Frecuencia</option>
                  <option value="Lavado y Desinfección de Tanques de Agua Potable">Lavado y Desinfección de Tanques de Agua Potable</option>
                </select>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-900 dark:text-white font-medium focus:ring-2 focus:ring-sky-500 focus:outline-none"
                  placeholder="Ej: Cilindro telescópico, Bomba Pedrollo 7.5 HP, Válvula Cheque 2''..."
                />
              </div>

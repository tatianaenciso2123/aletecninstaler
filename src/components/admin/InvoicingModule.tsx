            ...
            <form onSubmit={handleConfirmManualPayment} className="space-y-3.5 text-xs">
              ...
              <div>
                ...
                >
                  ...
                  <option value="EFECTIVO_VERIFICADO">Efectivo en Caja Menor (Recibo de Caja)</option>
                  <option value="NEQUI">Nequi QR</option>
                  <option value="DAVIPLATA">Daviplata</option>
                  <option value="TARJETA">Tarjeta de Crédito</option>
                  <option value="TRANSFERENCIA_BANCARIA">Transferencia Directa Bancolombia</option>
                </select>
              </div>
